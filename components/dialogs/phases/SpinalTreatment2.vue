    ...
    <div class="grid-container">
        ...
        <v-col cols="11">
          ...
          >
            ...
            <v-col v-for="(col, j) in cols" :key="j">
              <div class="mb-1 rotate colLabels">
                <strong>{{ col }}</strong>
              </div>
            </v-col>
          </v-row>
      ...
      <div class="scrollable-content">
        <v-row>
          ...
          <v-col cols="11">
            <v-row
              v-for="modifiedRow in modifiedRows(0, 1)"
              :key="modifiedRow.index"
            >
              <v-col class="text-center">
                <div class="mb-1">
              ...
              <v-col v-for="(col, j) in cols" :key="j">
                <div v-if="col === 'Physio Positioning' || col === 'Treatment Positioning' || col === 'Treatment Technique'">
                  <v-select
                    ...
                    v-model="answerGrid[0][4]"
                    :value="grid[modifiedRow.index][j]"
                  ></v-select>
                </div>
                <div
                  v-else
        ...
        <v-row>
          ...
          <v-col cols="11">
            <v-row
              v-for="modifiedRow in modifiedRows(1, 3)"
              :key="modifiedRow.index"
            >
              <v-col class="text-center">
                <div class="mb-1">
        ...
        <v-row>
          ...
          <v-col cols="11">
            <v-row
              v-for="modifiedRow in modifiedRows(3, 5)"
              :key="modifiedRow.index"
            >
              <v-col class="text-center">
                <div class="mb-1">
        ...
        <v-row>
          ...
          <v-col cols="11">
            <v-row
              v-for="modifiedRow in modifiedRows(5, 8)"
              :key="modifiedRow.index"
            >
              <v-col class="text-center">
                <div class="mb-1">
        ...
        <v-row>
          ...
          <v-col cols="11">
            <v-row
              v-for="modifiedRow in modifiedRows(8, 10)"
              :key="modifiedRow.index"
            >
              <v-col class="text-center">
                <div class="mb-1">
        ...
        <v-row>
          ...
          <v-col cols="11">
            <v-row
              v-for="modifiedRow in modifiedRows(10, 14)"
              :key="modifiedRow.index"
            >
              <v-col class="text-center">
                <div class="mb-1">
        ...
        <v-row>
          ...
          <v-col cols="11">
            <v-row
              v-for="modifiedRow in modifiedRows(14, 20)"
              :key="modifiedRow.index"
            >
              <v-col class="text-center">
                <div class="mb-1">
        ...
        <v-row>
          ...
          <v-col cols="11">
            <v-row
              v-for="modifiedRow in modifiedRows(20, 22)"
              :key="modifiedRow.index"
            >
              <v-col class="text-center">
                <div class="mb-1">
        ...
        <v-row>
          ...
          <v-col cols="11">
            <v-row
              v-for="modifiedRow in modifiedRows(22, 25)"
              :key="modifiedRow.index"
            >
              <v-col class="text-center">
                <div class="mb-1">
        ...
        <v-row>
          ...
          <v-col cols="11">
            <v-row
              v-for="modifiedRow in modifiedRows(25, 27)"
              :key="modifiedRow.index"
            >
              <v-col class="text-center">
                <div class="mb-1">
        ...
        <v-row>
          ...
          <v-col cols="11">
            <v-row
              v-for="modifiedRow in modifiedRows(27, 30)"
              :key="modifiedRow.index"
            >
              <v-col class="text-center">
                <div class="mb-1">
  ...
  export default {
    ...
    methods: {
      ...
      updateGrid(rowIndex, colIndex, value) {
        console.log("hitting and value is ", value);
        this.grid[rowIndex][colIndex] = value === '' ? null : value;
        this.$emit("update:spinalTreatmentGrid", this.grid);
      },
