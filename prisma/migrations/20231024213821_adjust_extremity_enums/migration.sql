/*
  ...
  - The values [knee_cap,scap] on the enum `entry_extremitylevel_enum` will be removed. If these variants are still used in the database, this will fail.

*/
-- AlterEnum
BEGIN;
CREATE TYPE "entry_extremitylevel_enum_new" AS ENUM ('shoulder', 'arm', 'bicep', 'tricep', 'elbow', 'wrist', 'hand', 'hip', 'thigh', 'leg', 'knee', 'calf', 'ankle', 'foot');
