    ...
    <v-container>
      <v-card class="elevation-4">
        <div class="py-5 d-flex">
          <v-card-title> Note List </v-card-title>
          <v-spacer></v-spacer>
          <v-btn color="primary" class="ma-2 pa-2" @click="noteDialog = true"
            >Add New Note</v-btn
          >
        </div>
        <v-table>
          <thead>
            <tr>
              <th class="text-left" @click="sortNotes('visitDate')">
                Visit Date
              </th>
              <th class="text-left" @click="sortNotes('patient.firstName')">
                First Name
              </th>
              <th class="text-left" @click="sortNotes('patient.lastName')">
                Last Name
              </th>
              <th class="text-left" @click="sortNotes('lastEdited')">
                Last Edited
              </th>
          ...
          <tbody class="">
            <tr v-for="item in displayedNotes" :key="item.id">
              ...
              <td class="d-flex justify-end">
                ...
                <v-btn class="ma-2 pa-2" color="primary" @click="goToNote(item)"
                  >See note</v-btn
                >
              </td>
            </tr>
